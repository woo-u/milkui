<template>
  <div id="content" class="milk-select-page">
    <h2 class="milk-font--title20">Select</h2>
    <nav>
    ...
    <div v-if="nav === 'code'">
      <!--Single select-->
      <h3 class="milk-font--title10">Single select</h3>
      ...
      <div>
        ...
        <div class="style-box">
          ...
          <ul>
            ...
            <li>Box-fill: hover(drop menus): #F4F5F7</li>
